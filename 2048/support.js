...
function get_number_color(number) {
	if (number <= 0="" 4)="" return="" '#776e65';="" 'white';="" }="" function="" nospace(board)="" {="" for="" (var="" i="0;" <="" 4;="" i++)="" j="0;" j++)="" if="" (board[i][j]="=" 0)="" false;="" true;="" can_move_left(board)="" !="0)" (board[i][j="" -="" 1]="=" ||="" board[i][j]="=" board[i][j="" 1])="" can_move_right(board)="">= 0; j--) {
			if (board[i][j] != 0) {
